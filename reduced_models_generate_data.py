...
if __name__ == '__main__':
    ...
    # Reduced 1 species model
    numpy.savetxt('BFM_Reduced_Models_Data/reduced_1_t_data.csv', integration_results[4].t)
    numpy.savetxt('BFM_Reduced_Models_Data/reduced_1_c_data.csv', integration_results[4].y)
