...
from BFM50_rate_eqns import bfm50_rate_eqns
from BFM_reduced_rate_eqns import bfm_reduced_rate_eqns
...
if __name__ == '__main__':
    ...
    output_file = open("timer_data.txt", "w")
    for duration in timer_data.items():
        output_file.write('{} \n'.format(duration))
    output_file.close()
