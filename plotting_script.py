...
if __name__ == '__main__':
    ...
    species_names_units = ['Oxygen (mmol O$_2$/m$^3$)', 
                            ...
                            'Particulate Organic Nitrogen (mmol N/m$^3$)',
    ...
    reduced_2_t = numpy.genfromtxt('BFM_Reduced_Models_Data/reduced_21_t_data.csv')
    reduced_2_c = numpy.genfromtxt('BFM_Reduced_Models_Data/reduced_21_c_data.csv', delimiter=' ')
    ...
    reduced_4_t = numpy.genfromtxt('BFM_Reduced_Models_Data/reduced_1_t_data.csv')
    reduced_4_c = numpy.genfromtxt('BFM_Reduced_Models_Data/reduced_1_c_data.csv', delimiter=' ')
    ...
    ax.plot(reduced_2_t/86400/365, reduced_2_c[48], 's', markersize=2, color = colors[1], label='Reduced model')
    ax.set_ylabel(species_names_units[48])
    ax.set_xlabel('Time (year)')
    ax.set_xlim(5,10)
    ax.set_ylim(bottom = 27000, top=29500)
    ...
    ax.yaxis.set_tick_params(which='major', size=10, width=2, direction='out')
    ax.yaxis.set_tick_params(which='minor', size=7, width=2, direction='out')
    plt.savefig('Plots/reduced_40_PON.pdf', bbox_inches = "tight")
    plt.close('all')
    
    # ------------------------------------------------------------------------
    # Reduced 1 species model plot
    fig = plt.figure(figsize=(10,5))
    ax = fig.add_axes([0, 0, 1, 1])
    ax.grid(linestyle='--')
    ...
    ax.yaxis.set_tick_params(which='major', size=10, width=2, direction='out')
    ax.yaxis.set_tick_params(which='minor', size=7, width=2, direction='out')
    plt.savefig('Plots/reduced_1_oxygen.pdf', bbox_inches = "tight")
    plt.close('all')
